...
class CometChatMessageList extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        this.item =
            this.context.type === CometChat.ACTION_TYPE.TYPE_USER || CometChat.ACTION_TYPE.TYPE_GROUP ? this.context.item : {};
    ...
    onMessageReceived = (message) => {
        ...
        if (
             ...
             */
            if (
                (message.getSender().uid === this.context.item.uid && message.getReceiverId() === this.state.loggedInUser?.uid) ||
